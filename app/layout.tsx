...
export const metadata: Metadata = {
  ...
  icons: {
    icon: 'https://raw.githubusercontent.com/NewlanderDesign/nad2026/main/public/nad-module.png?v=1',
    apple: 'https://raw.githubusercontent.com/NewlanderDesign/nad2026/main/public/nad-module.png?v=1',
  },
};
